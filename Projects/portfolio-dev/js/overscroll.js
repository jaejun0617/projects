            ...
            _ = (function () {
               ...
               return (
                  ...
                  (t.prototype.adjust = function () {
                     ...
                     (o === this._canvas.width && i === this._canvas.height) ||
                  ...
                  (t.prototype.render = function (t, e) {
                     ...
                     if (i || n) {
                        ...
                        (this._ctx.clearRect(
                           ...
                           this._renderX(i),
                           this._renderY(n));
                     } else a(this._canvas, { display: 'none' });
                  }),
                  ...
                  (t.prototype._renderY = function (t) {
                     var e = this._scrollbar.size,
                        ...
                        n = i.height,
                        s = this._ctx;
                     (s.save(), t > 0 && s.transform(1, 0, 0, -1, 0, n));
                     var c = h(Math.abs(t) / o, 0, 0.75),
                        a = h(c, 0, 0.25) * r,
                        l = this._touchX || r / 2,
                        u = Math.abs(t);
               ...
               return (
                  ...
                  (e.prototype._absorbMomentum = function (t, e) {
                     var o = this.options,
                        ...
                        r = this._amplitude;
                     d.test(i) &&
                        (r[t] = h(e, -o.maxOverscroll, o.maxOverscroll));
                  }),
                              ...
                              (1 -
                                 (c
                                    ...
                                    : this._wheelScrollBack[t]
                                      ? 1
                                      : Math.abs(s / o.maxOverscroll)));
                     ((r[t] =
                        0 === i.offset[t]
                           ? h(a, -o.maxOverscroll, 0)
                           : h(a, 0, o.maxOverscroll)),
                        c && (n[t] = r[t]));
                  }),
                  (e.prototype._render = function () {
                     ...
                     if (this._enabled && (e.x || e.y || o.x || o.y)) {
                        ...
                        'function' == typeof t.onScroll &&
                           t.onScroll.call(this, r({}, o));
                     }
                  }),
                  (e.prototype._nextAmp = function (t) {
                     ...
                     return (
                        ...
                        this._wheelScrollBack[t] &&
                           Math.abs(l) <= 1 &&
                           ((this._wheelScrollBack[t] = !1),
                           (this._lockWheel[t] = !0)),
                        { amplitude: c, position: l }
                     );
                  }),
